...
Green In House no es una simple maceta, si no que es un proyecto que aglutina una gran cantidad de funcionalidades y tecnologías diferentes, las cuales han sido desarrolladas utilizando las siguientes herramientas.
    ...
    % \begin{itemize}
    %     \item \textbf{MCP3008:} conversor de 8 señales analógicas a digitalES (ADC).
    %     \item \textbf{DHT11:} sensor de humedad y temperatura ambiente de señal digital.
    %     \item \textbf{LM35:} sensor de temperatura ambiente de señal analógica.
    %     \item \textbf{FC28:} sensor de humedad de tierra de la maceta de señal analógica.
    %     \item \textbf{LDR:} sensor de luminosidad ambiente de señal analógica.
    %     \item \textbf{BH1750:} sensor de luminosidad ambiente de señal digital.  
    % \end{itemize}
    \begin{table}[ht]
    \resizebox{13cm}{!} {
    \centering
    ...
    \subsection{GitHub: Plataforma \textit{open source} de repositorios}
    ...
    \subsection{Utilización de GitHub en Green In House}
